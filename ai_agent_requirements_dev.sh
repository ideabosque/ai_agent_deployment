...
echo "y" | pip uninstall ai_marketing_engine && pip install git+https://github.com/ideabosque/ai_marketing_engine.git@dev#egg=ai_marketing_engine
echo "y" | pip uninstall ai_coordination_engine && pip install git+https://github.com/ideabosque/ai_coordination_engine.git@dev#egg=ai_coordination_engine
...
python3.11 cloudformation_stack.py .env silvaengine-microcore-ai-agent